...
import nestlersImg from "../../assets/Bsr.jpg";
...
export default function BsrProgram() {
  ...
  return (
    <div className="bg-[#FAF7F2] text-gray-900 overflow-hidden">
      ...
      {/* ---------------- HERO SECTION ---------------- */}
      <section className="min-h-[75vh] flex flex-col md:flex-row items-center px-6 md:px-16 lg:px-30 lg:gap-12 py-12 bg-gradient-to-b from-[#ccce67] to-[#fff]">
