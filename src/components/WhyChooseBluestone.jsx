      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="mt-6 text-gray-600 text-lg leading-relaxed max-w-xl">
            Every child learns differently. At Bluestone, we nurture emotional, social, and 
            academic growth through joyful, play-based experiences designed to build confidence, 
        ...
        >
          {[{
            ...
            darkFrom: "rgba(124,45,18,0.85)",
            darkTo: "rgba(88,28,135,0.85)",
            ...
            darkFrom: "rgba(15,118,110,0.85)",
            darkTo: "rgba(30,64,175,0.85)",
            radius: "rounded-tl-[36px] rounded-tr-[36px]",
          },{
