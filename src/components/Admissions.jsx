...
export default function Admissions() {
  ...
  return (
    <div className="overflow-x-hidden font-sans">
      ...
      <section className="relative min-h-[90vh] w-full flex items-center justify-center px-4 py-16" style={{ backgroundImage: `url(${bgImg})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="relative z-10 max-w-7xl w-full grid lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} className="hidden lg:flex flex-col items-center justify-center relative">
            <motion.img animate={{ y: [0, -15, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} src={boyImg} alt="Happy Child" className="h-[500px] xl:h-[580px] object-contain drop-shadow-2xl" />
          </motion.div>
        </div>
      </section>
