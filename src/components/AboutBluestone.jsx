  ...
  return (
    ...
    to-orange-500/70"
        ...
        >
          ...
          >
            A nurturing space where curiosity blooms, confidence grows, and
        ...
        <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Through play-based education, emotional nurturing, and strong
              foundational skills, we prepare children not just for school — but
              for life.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-[1fr_2fr] gap-20 items-center">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              We focus on emotional intelligence, creativity, confidence, and
              strong values — nurturing children for a beautiful future.
            </p>
          </motion.div>
        </div>
      </section>
